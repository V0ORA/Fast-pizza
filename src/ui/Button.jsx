...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    small: base + 'px-4 py-2 md:px-5 md:py-2.5 md:text-sm text-xs',
    round: base + 'px-2.5 py-1 md:px-3.5 md:py-2 md:text-sm ',
    secondary:
      'inline-block rounded-full border-2 border-stone-300 px-4 py-2.5 text-sm font-semibold uppercase tracking-wide text-stone-400 transition-colors hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200  focus:text-stone-800 focus:ring-offset-2 disabled:cursor-not-allowed md:px-6 md:py-3.5 ',
  };
